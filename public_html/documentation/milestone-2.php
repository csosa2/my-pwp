...
<html>
	...
	<body>
		...
		<main>
			<h2>Sitemap</h2>
			<p>This personal web site will contain 4 page-level pages total. No sub-pages or sub-navigation. This will
				be teh Minimum Viable Product. The web site will contain the following pages: </p>
			<ul>
				<li>Home (main menu)</li>
				<li>About Me</li>
				<li>Portfolio</li>
				<li>Contact</li>
			</ul>
			...
			<p><strong>Portfolio: </strong>This section will showcase 2-5 examples of my past projects procurred in the
				Deep Dive Coding Bootcamp and any future work. This will be a responsive image galary linking to all
				my projects.</p>
